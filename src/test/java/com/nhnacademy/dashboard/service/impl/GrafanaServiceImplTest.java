...
class GrafanaServiceImplTest {
    ...
    void setUp() {
        ...
        grafanaDashboardInfo = new GrafanaDashboardInfo("Sample Dashboard", "dashboard-uid", "folder-uid");
    }
    ...
    void getFolderUidByTitle() {
        ...
        Mockito.when(grafanaAdapter.getAllFolders(Mockito.anyString())).thenReturn(List.of(grafanaFolder));
    ...
    void getDashboardNameUidByTitle() {
        ...
        Mockito.when(grafanaAdapter.searchDashboards(Mockito.anyString(),Mockito.anyString(),Mockito.anyString())).thenReturn(List.of(grafanaDashboardInfo));
    ...
    void getDashboardsInFolder() {
        ...
        List<GrafanaDashboardInfo> folderUid = grafanaService.getDashboardsInFolder("folder-uid");
